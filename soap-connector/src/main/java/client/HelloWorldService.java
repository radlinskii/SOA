 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://soap/", wsdlLocation = "http://localhost:8080/lab2-ejb/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICE_QNAME = new QName("http://soap/", "HelloWorldService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/lab2-ejb/HelloWorld?wsdl");
    ...
    public HelloWorld getHelloWorldPort() {
        return super.getPort(new QName("http://soap/", "HelloWorldPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap/", "HelloWorldPort"), HelloWorld.class, features);
    }
